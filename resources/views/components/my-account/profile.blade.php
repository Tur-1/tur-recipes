<div wire:ignore.self class="offcanvas offcanvas-end " tabindex="-1" id="account-settings"
    aria-labelledby="offcanvasExampleLabel">
    <div class="offcanvas-header shadow-sm">

        <button type="button" data-bs-dismiss="offcanvas" class="bg-transparent border-0 text-start ms-0 ps-0">
    ...
    <div wire:ignore.self class="offcanvas-body  mt-3">
        ...
        <div wire:ignore.self class="card shadow-sm mb-4 ">
            ...
            <div class="profile-card-header " id="update-header-card-account">
                <button class="btn-close btn-close-white " id="close-account-from-btn"> </button>
                <h6 class="card-title">ACCOUNT INFO</h6>
                <a role="button" href="#" class="text-primary font-size-25" wire:click.prevent="submitAccountInfo">
        ...
        <div wire:ignore.self class="card shadow-sm mb-4 w-100 border-0">
            ...
            <div class="card-body">
                ...
                <div class="password-form d-none">
                    <div class="mb-3">
