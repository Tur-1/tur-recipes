<head>
    ...
    <link rel="apple-touch-startup-image" href="{{ asset('images/icons/apple-splash-dark-2732-2048.jpg') }}"
    ...
    <link rel="apple-touch-startup-image" href="{{ asset('images/icons/apple-splash-dark-2388-1668.jpg') }}"
    ...
    <link rel="apple-touch-startup-image" href="{{ asset('images/icons/apple-splash-dark-2048-1536.jpg') }}"
    ...
    <link rel="apple-touch-startup-image" href="{{ asset('images/icons/apple-splash-dark-2224-1668.jpg') }}"
    ...
    <link rel="apple-touch-startup-image" href="{{ asset('images/icons/apple-splash-dark-2160-1620.jpg') }}"
    ...
    <link rel="apple-touch-startup-image" href="{{ asset('images/icons/apple-splash-dark-2778-1284.jpg') }}"
    ...
    <link rel="apple-touch-startup-image" href="{{ asset('images/icons/apple-splash-dark-2532-1170.jpg') }}"
    ...
    <link rel="apple-touch-startup-image" href="{{ asset('images/icons/apple-splash-dark-2436-1125.jpg') }}"
    ...
    <link rel="apple-touch-startup-image" href="{{ asset('images/icons/apple-splash-dark-2688-1242.jpg') }}"
    ...
    <link rel="apple-touch-startup-image" href="{{ asset('images/icons/apple-splash-dark-1792-828.jpg') }}"
    ...
    <link rel="apple-touch-startup-image" href="{{ asset('images/icons/apple-splash-dark-2208-1242.jpg') }}"
    ...
    <link rel="apple-touch-startup-image" href="{{ asset('images/icons/apple-splash-dark-1334-750.jpg') }}"
    ...
    <link rel="apple-touch-startup-image" href="{{ asset('images/icons/apple-splash-dark-1136-640.jpg') }}"
